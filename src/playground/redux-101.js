...
const incrementCount = ({incrementBy = 1} = {}) => ({   // Can use object deconstruction to set defaults for both function argument and any objects passsed in.
...
const countReducer = (state = {count: 0}, action) => { // countReducer takes a function with two arguments - state and action. 
    ...
    switch (action.type) {  // Switch statement to handle action types.  
        case 'INCREMENT':
            return {
